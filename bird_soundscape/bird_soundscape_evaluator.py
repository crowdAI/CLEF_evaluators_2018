...
#query and time-code to remove from the ground truth because there are some mistake (long duration)
timecoded_soundscape_segment_to_remove = {}
timecoded_soundscape_segment_to_remove['49887'] = ['00:02:15-00:07:38']
timecoded_soundscape_segment_to_remove['49899'] = ['00:02:48-00:15:58']
timecoded_soundscape_segment_to_remove['49893'] = ['00:01:12-00:11:30']
timecoded_soundscape_segment_to_remove['49869'] = ['00:05:47-00:16:06']
timecoded_soundscape_segment_to_remove['49878'] = ['00:00:55-00:15:10']
...
class BirdSoundscapeEvaluator:
    ...
    def _evaluate(self, client_payload, context={}):
        print("Processing in side evaluator....")
    ...
    def load_gt(self):
        ...
        with open(self.answer_file_path) as csvfile:
            ...
            for row in reader:
                ...
                timecode_not_excluded = True
                if query in timecoded_soundscape_segment_to_remove:
                    if timecodes in timecoded_soundscape_segment_to_remove[query]:
                        timecode_not_excluded = False

                if timecode_not_excluded:
    ...
    def load_predictions(self, submission_file_path):
        ...
        max_propositions = 100 #max nbr of classes for query_tc
        ...
        with open(submission_file_path) as csvfile:
            ...
            for row in reader:
                ...
                timecodes = row[1]
                #Check time interval => Errors are thrown in check_time_interval method
                self.check_time_interval(timecodes, lineCnt)

                # Media ID not in testset => Error
...
if __name__ == "__main__":
  ...
  submission_file_path = "runs/01_univ-tln-run1.csv"
  #submission_file_path = "runs/02_not_4_tokens.csv"
  #submission_file_path = "runs/03_time_interval_not_2_tokens.csv"
  #submission_file_path = "runs/04_time_interval_cannot_parse.csv"
  #submission_file_path = "runs/05_time_interval_not_multiple_of_5.csv"
  #submission_file_path = "runs/06_time_interval_wrong_duration.csv"
  #submission_file_path = "runs/07_wrong_media_id.csv"
  #submission_file_path = "runs/08_invalid_class_id.csv"
  #submission_file_path = "runs/09_score_no_nbr.csv"
  #submission_file_path = "runs/10_score_not_btw_0_and_1.csv"
  #submission_file_path = "runs/11_more_than_100_predictions_for_queryTC.csv"
  #submission_file_path = "runs/12_prediction_for_queryTC_already_exists.csv"
